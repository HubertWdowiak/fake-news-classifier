...
def get_user_data(retweets_df: pd.DataFrame, tweets_df: pd.DataFrame) -> pd.DataFrame:
    if retweets_df.empty:
        all_users = tweets_df['user']
    else:
...
if __name__ == '__main__':
    ...
    fake_directory = os.path.join('politifact', 'fake')
